...
<body>
    ...
    <ul id="side-nav" class="side-nav white lighten-4">
        ...
        <li class="active">
            <a href="#">
                <div><i class="grey-text text-darken-3 fas fa-newspaper fa-fw fa-lg" data-fa-transform="grow-4 up-1"></i>&nbsp; &nbsp; &nbsp; <b>News and Updates</b></div>
            </a>
        </li>
        <li>
            <a href="support.php">
    ...
    <nav class="blue-grey darken-4" style="height:45px; background:url(../_assets/img/bckgrnds/material1.png); background-size: cover; background-repeat: no-repeat;">
        <div class="nav-wrapper ">
            <div class="col s12 container" >
                <h5><i class="fa fa-newspaper fa-sm" data-fa-transform="right-2 up-1"></i> &nbsp; News &amp; Updates <span class="right hide-on-small-only"><?php echo $email; ?></span></h5>
            </div>
