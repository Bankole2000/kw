...
if(isset($_GET['user_id'])){
    ...
    $sql= "SELECT * FROM user_table JOIN states ON user_table.state_id = states.state_id JOIN banks ON user_table.bank_id = banks.bank_id WHERE user_id = '{$_GET['user_id']}' LIMIT 1";
        $result = $db->query($sql);
...
<head>
    <meta charset="UTF-8">
    <title>View <?php echo $first_name;?>'s Details</title>
...
<!--   Home Section -->
                   ...
                   <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card br-primary text-center card-form">
                                <div class="card-body">
                                   <input type="hidden" id="user_id_main" value="<?php echo $user_id;?>">
                                    <img src="../user/<?php echo $profile_pic;?>" alt="" class="img-fluid" id="profile_pic">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 d-lg-block">
                           <div class="card br-primary" style="padding:15px;"><h1 class="text-black" id="full_name"><?php echo $first_name.' '.$last_name;?></h1>
   ...
   <section>
       <div class="container" style="padding-top:100px; padding-bottom:20px;">
           <div><div class="container" style="display:none;"><div class="row center">
