...
<body>
    ...
    <ul id="side-nav" class="side-nav white lighten-4">
        ...
        <li class="active">
            <a>
                <div><i class="orange-text lighten-1 fas fa-user-edit fa-fw fa-lg" data-fa-transform="grow-4 up-1"></i>&nbsp; &nbsp; <b>My Profile</b><span class="new badge orange lighten-1 pulse">Incomplete</span></div>
            </a>
        </li>
 ...
 <a href='logout.php'>Log out?</a>";
    ...
    <i class="fas fa-power-off fa-2x" data-fa-transform="down-4"></i>
        ...
        <ul>
           <li><a class="btn-floating btn-large orange waves-effect waves-light tooltipped" data-tooltip="My Profile" data-position="left"><i class="fas fa-user fa-lg" data-fa-transform="grow-6 down-1"></i></a></li>
