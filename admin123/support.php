...
<body>
            ...
            <div class="container">
                ...
                <i class="left fas fa-bars black-text" data-fa-transform="grow-18 down-25"></i>
                    ...
                    <ul class="hide-on-small-only right">
                        ...
                        <li><a href="profile.html" data-tooltip="My Profile" data-position="right" class="tooltipped"><img src="<?php echo $profile_pic; ?>" style="width:50px; margin-top:7px;" class="circle" alt=""></a></li>
    ...
    <ul id="side-nav" class="side-nav white lighten-4">
            ...
            <ul class="collapsible collapsible-accordion">
                <li>
                    <a class="collapsible-header">
                        <div><i class="red-text text-lighten-1 fas fa-user-friends fa-fw fa-lg"></i>&nbsp; &nbsp; Matches<span class="new badge red lighten-1 pulse">99+</span></div>
                    </a>
        ...
        <li class="active">
            <a href="support.php">
                <div><i class="grey-text text-darken-3 fas fa-cog fa-fw fa-lg" data-fa-transform="grow-6 up-1"></i>&nbsp; &nbsp; &nbsp; <b>Support</b> </div>
            </a>
        </li>
    ...
    <nav class="blue-grey darken-4" style="height:45px;">
        <div class="nav-wrapper ">
            <div class="col s12 container" >
                <h5><i class="fa fa-cog fa-sm" data-fa-transform="right-2 up-1"></i> &nbsp; Support <span class="right hide-on-small-only"><?php echo $email; ?></span></h5>
            </div>
    ...
    <i class="fas fa-power-off fa-2x" data-fa-transform="down-4"></i>
        ...
        <ul>
           <li><a href="profile.php" class="btn-floating orange waves-effect waves-light tooltipped" data-tooltip="My Profile" data-position="left"><i class="fas fa-user fa-lg" data-fa-transform="down-1"></i></a></li>
            ...
            <li><a href="support.php" class="tooltipped btn-floating btn-large teal waves-effect waves-light" data-tooltip="Help & Support" data-position="left"><i class="fas fa-cog fa-lg" data-fa-transform="grow-12 down-1"></i></a></li>
